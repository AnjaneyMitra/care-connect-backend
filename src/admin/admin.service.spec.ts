...
describe("AdminService", () => {
    ...
    describe("banUser", () => {
        it("should ban a user", async () => {
            ...
            const mockUpdate = jest.fn().mockResolvedValue({ id: userId, is_active: false, ban_reason: reason });
            ...
            expect(result).toEqual({ id: userId, is_active: false, ban_reason: reason });
        });
    });
    ...
    describe("unbanUser", () => {
        it("should unban a user", async () => {
            const userId = "user-123";
            const mockUpdate = jest.fn().mockResolvedValue({ id: userId, is_active: true, ban_reason: null });
            (service as any).prisma.users.update = mockUpdate;
